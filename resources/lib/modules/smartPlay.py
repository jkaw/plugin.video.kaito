...
class SmartPlay:
    ...
    def __init__(self, item_information):
        ...
        self.anilist_id = self.item_information.get("anilist_id")
    ...
    def get_season_info(self):
        ...
        :rtype:
        """
        return tools.get_item_information(self.anilist_id)
    ...
    def get_play_menu_item(self, item_information):
        """
        Uses available information to add relevant episodes to the current playlist
        :param season_id: Trakt ID of season to build
        :type season_id: int
        ...
        episode = item_information['episode']

        try:
            return self.list_builder.episode_list_builder(
                    anilist_id,
                    self.show_trakt_id,
                    None,
                    minimum_episode=episode,
                    smart_play=True,
                    hide_unaired=True,
    ...
    def is_season_final(self):
        ...
        """
        show = self.get_season_info()

        if self.item_information["info"]["episode"] == show["episode_count"]:
            return True
        else:
            return False
