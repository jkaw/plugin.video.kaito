...
class MetadataHandler(object):
    ...
    def format_meta(self, db_object):
        ...
        result.update(
            self._apply_best_fit_meta_data(
                anilist_data, trakt_data, tmdb_object, tvdb_object, fanart_object, omdb_object
            )
        )
    ...
    def _apply_best_fit_meta_data(
        self, anilist_data, trakt_data, tmdb_data, tvdb_data, fanart_object, omdb_object
    ):
        if anilist_data:
            media_type = anilist_data["info"]["mediatype"]
        elif trakt_data:
    ...
    def _apply_best_fit_art(
        self, result, anilist_object, tmdb_object, tvdb_object, fanart_object, media_type
    ):
    ...
    def _apply_best_fit_info(
        self, result, anilist_data, trakt_data, tmdb_data, tvdb_data, omdb_object,
    ):
        if anilist_data:
            result.update({"info": anilist_data.get("info")})
        elif trakt_data:
    ...
    def update(self, db_object):
        ...
        :rtype:list[dict]
        """
        media_type = MetadataHandler.get_anilist_info(db_object, "mediatype")
    ...
    @staticmethod
    def anilist_object(data):
        return data.get("anilist_object", {})
    ...
    @staticmethod
    def anilist_info(data):
        return MetadataHandler.info(MetadataHandler.anilist_object(data))
    ...
    @staticmethod
    def anilist_art(data):
        return MetadataHandler.art(MetadataHandler.anilist_object(data))

    @staticmethod
    def get_anilist_info(data, key, default=None):
        try:
            return MetadataHandler.anilist_info(data).get(key, default)
        except:
            return default
